                ...
                <FormItem>
                  <div className="flex items-center gap-2">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent><p>Select a cuisine to guide the recipe style.</p></TooltipContent>
                    </Tooltip>
                  </div>
              ...
              render={({ field }) => (
                <FormItem>
                  <div className="flex items-center gap-2">
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild><Info className="h-4 w-4 text-muted-foreground cursor-help" /></TooltipTrigger>
                      <TooltipContent><p>Choose the type of meal you want to make.</p></TooltipContent>
                    </Tooltip>
                  </div>
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl>
              ...
              render={({ field }) => (
                <FormItem>
                  <div className="flex items-center gap-2">
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild><Info className="h-4 w-4 text-muted-foreground cursor-help" /></TooltipTrigger>
                      <TooltipContent><p>Set the desired cooking difficulty.</p></TooltipContent>
                    </Tooltip>
                  </div>
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl>
            ...
            render={() => (
              <FormItem>
                <div className="mb-4 flex items-center gap-2">
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild><Info className="h-4 w-4 text-muted-foreground cursor-help" /></TooltipTrigger>
                    <TooltipContent><p>Select any dietary restrictions.</p></TooltipContent>
                  </Tooltip>
                </div>
